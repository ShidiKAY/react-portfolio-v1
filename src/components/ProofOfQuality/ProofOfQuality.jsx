...
import { FaCube, FaShieldAlt, FaVideo } from "react-icons/fa";
...
<p className="text-slate-600 dark:text-slate-300 text-base font-medium">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-300 text-base leading-relaxed mb-2">
            ...
            <TerminalMockup>
              {hasCypressAsset ? (
                ...
                <div className="w-full py-12 px-6 text-center border border-dashed border-slate-300 dark:border-slate-600 rounded-lg bg-slate-100/50 dark:bg-slate-800/50">
                  <FaVideo className="w-10 h-10 mx-auto text-slate-400 dark:text-slate-500 mb-3" aria-hidden="true" />
            ...
            <div className="mt-4 p-4 rounded-sm bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-700">
              <p className="text-emerald-800 dark:text-emerald-200 font-semibold text-sm mb-3">
                {t("common.proof_cypress_benefits_title")}
              </p>
              <ul className="list-none space-y-1.5 text-emerald-800 dark:text-emerald-200 text-sm">
